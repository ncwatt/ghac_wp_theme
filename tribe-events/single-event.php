...
<div id="tribe-events-content" class="tribe-events-single">
	...
	<?php while ( have_posts() ) :  the_post(); ?>
		<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
			...
			<?php
				// Get the features image html markup
				$img_html = tribe_event_featured_image( $event_id, 'full', false );
				// Remove the width and height attribuates and replace with a fluid image class
				$img_updated = preg_replace('/\s*(width|height)="[^"]*"/i', ' class="img-fluid" ', $img_html);
				// Output the updated image html
				echo $img_updated;
			?>
